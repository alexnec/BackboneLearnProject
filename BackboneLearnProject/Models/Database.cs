...
namespace BackboneLearnProject.Models
{
    public class Database
    {
        ...
        public static List<Agent> Agents = new List<Agent> {
            new Agent{AgentID=1, CodeName="007", FirstName="James", LastName="Bond", 
                ImagePath="images/JamesBondImage.png", Description="Killer"},
            new Agent{AgentID=2, CodeName="Q", FirstName="Desmond", LastName="Llewelyn", 
                ImagePath="images/LDesmond.png", Description="Master of Gadgets"},
            new Agent{AgentID=3, CodeName="Ive", FirstName="Vesper", LastName="Lynd", 
                ImagePath="images/VesperLynd.png", Description="Seducer"},
            new Agent{AgentID=4, CodeName="King", FirstName="Chuck", LastName="Noris", 
                ImagePath="images/ChuckNoris.png", Description="Facts Collector"},
        };
